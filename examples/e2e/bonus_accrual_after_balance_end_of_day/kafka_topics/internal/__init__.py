from hamcrest import equal_to, matches_regexp, not_none
from kafka.consumer.fetcher import ConsumerRecord

from helpers import check_assert_that, get_test_uuid
...
class BaseTopic:
    ...
    def _check_headers(self, message: ConsumerRecord, producer_name):
        ...
        check_assert_that(
            ...
            matches_regexp('^00-[0-9a-f]{32}-[0-9a-f]{16}-00$'),
            'Ошибка в traceparent',
        )
