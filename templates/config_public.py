...
addresses, credentials, topic names, or synthetic demo identity data.
"""
...
# Synthetic event contract names used by the Reward Ledger Demo.
...
# Compatibility aliases retained by the portfolio examples.
...
demo_partner_shared_secret = os.environ.get("DEMO_PARTNER_SHARED_SECRET", "placeholder-secret")
demo_api_host = "example.test"
